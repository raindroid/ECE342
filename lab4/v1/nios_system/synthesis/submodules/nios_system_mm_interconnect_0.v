...
module nios_system_mm_interconnect_0 (
		...
		input  wire [22:0] nios2_data_master_address,                 //                   nios2_data_master.address
		...
		output wire [2:0]  LDA_s1_address,                            //                              LDA_s1.address
		output wire        LDA_s1_write,                              //                                    .write
		output wire        LDA_s1_read,                               //                                    .read
		input  wire [31:0] LDA_s1_readdata,                           //                                    .readdata
		output wire [31:0] LDA_s1_writedata,                          //                                    .writedata
		input  wire        LDA_s1_waitrequest,                        //                                    .waitrequest
	...
	wire  [22:0] nios2_data_master_translator_avalon_universal_master_0_address;              // nios2_data_master_translator:uav_address -> nios2_data_master_agent:av_address
	...
	wire  [22:0] nios2_instruction_master_translator_avalon_universal_master_0_address;       // nios2_instruction_master_translator:uav_address -> nios2_instruction_master_agent:av_address
	...
	wire  [22:0] nios2_jtag_debug_module_agent_m0_address;                                    // nios2_jtag_debug_module_agent:m0_address -> nios2_jtag_debug_module_translator:uav_address
	...
	wire  [99:0] nios2_jtag_debug_module_agent_rf_source_data;                                // nios2_jtag_debug_module_agent:rf_source_data -> nios2_jtag_debug_module_agent_rsp_fifo:in_data
	...
	wire  [99:0] nios2_jtag_debug_module_agent_rsp_fifo_out_data;                             // nios2_jtag_debug_module_agent_rsp_fifo:out_data -> nios2_jtag_debug_module_agent:rf_sink_data
	...
	wire  [98:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> nios2_jtag_debug_module_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                       // nios2_jtag_debug_module_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [5:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> nios2_jtag_debug_module_agent:cp_channel
	...
	wire  [22:0] leds_s1_agent_m0_address;                                                    // LEDs_s1_agent:m0_address -> LEDs_s1_translator:uav_address
	...
	wire  [31:0] lda_s1_agent_m0_readdata;                                                    // LDA_s1_translator:uav_readdata -> LDA_s1_agent:m0_readdata
	wire         lda_s1_agent_m0_waitrequest;                                                 // LDA_s1_translator:uav_waitrequest -> LDA_s1_agent:m0_waitrequest
	wire         lda_s1_agent_m0_debugaccess;                                                 // LDA_s1_agent:m0_debugaccess -> LDA_s1_translator:uav_debugaccess
	wire  [22:0] lda_s1_agent_m0_address;                                                     // LDA_s1_agent:m0_address -> LDA_s1_translator:uav_address
	wire   [3:0] lda_s1_agent_m0_byteenable;                                                  // LDA_s1_agent:m0_byteenable -> LDA_s1_translator:uav_byteenable
	wire         lda_s1_agent_m0_read;                                                        // LDA_s1_agent:m0_read -> LDA_s1_translator:uav_read
	wire         lda_s1_agent_m0_readdatavalid;                                               // LDA_s1_translator:uav_readdatavalid -> LDA_s1_agent:m0_readdatavalid
	wire         lda_s1_agent_m0_lock;                                                        // LDA_s1_agent:m0_lock -> LDA_s1_translator:uav_lock
	wire  [31:0] lda_s1_agent_m0_writedata;                                                   // LDA_s1_agent:m0_writedata -> LDA_s1_translator:uav_writedata
	wire         lda_s1_agent_m0_write;                                                       // LDA_s1_agent:m0_write -> LDA_s1_translator:uav_write
	wire   [2:0] lda_s1_agent_m0_burstcount;                                                  // LDA_s1_agent:m0_burstcount -> LDA_s1_translator:uav_burstcount
	wire         lda_s1_agent_rf_source_valid;                                                // LDA_s1_agent:rf_source_valid -> LDA_s1_agent_rsp_fifo:in_valid
	wire  [99:0] lda_s1_agent_rf_source_data;                                                 // LDA_s1_agent:rf_source_data -> LDA_s1_agent_rsp_fifo:in_data
	wire         lda_s1_agent_rf_source_ready;                                                // LDA_s1_agent_rsp_fifo:in_ready -> LDA_s1_agent:rf_source_ready
	wire         lda_s1_agent_rf_source_startofpacket;                                        // LDA_s1_agent:rf_source_startofpacket -> LDA_s1_agent_rsp_fifo:in_startofpacket
	wire         lda_s1_agent_rf_source_endofpacket;                                          // LDA_s1_agent:rf_source_endofpacket -> LDA_s1_agent_rsp_fifo:in_endofpacket
	wire         lda_s1_agent_rsp_fifo_out_valid;                                             // LDA_s1_agent_rsp_fifo:out_valid -> LDA_s1_agent:rf_sink_valid
	wire  [99:0] lda_s1_agent_rsp_fifo_out_data;                                              // LDA_s1_agent_rsp_fifo:out_data -> LDA_s1_agent:rf_sink_data
	wire         lda_s1_agent_rsp_fifo_out_ready;                                             // LDA_s1_agent:rf_sink_ready -> LDA_s1_agent_rsp_fifo:out_ready
	wire         lda_s1_agent_rsp_fifo_out_startofpacket;                                     // LDA_s1_agent_rsp_fifo:out_startofpacket -> LDA_s1_agent:rf_sink_startofpacket
	wire         lda_s1_agent_rsp_fifo_out_endofpacket;                                       // LDA_s1_agent_rsp_fifo:out_endofpacket -> LDA_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> LDA_s1_agent:cp_valid
	wire  [98:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> LDA_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                       // LDA_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [5:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> LDA_s1_agent:cp_channel
	wire         cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> LDA_s1_agent:cp_startofpacket
	wire         cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> LDA_s1_agent:cp_endofpacket
	...
	wire  [98:0] nios2_jtag_debug_module_agent_rp_data;                                       // nios2_jtag_debug_module_agent:rp_data -> router_003:sink_data
	...
	wire         lda_s1_agent_rp_valid;                                                       // LDA_s1_agent:rp_valid -> router_007:sink_valid
	wire  [98:0] lda_s1_agent_rp_data;                                                        // LDA_s1_agent:rp_data -> router_007:sink_data
	wire         lda_s1_agent_rp_ready;                                                       // router_007:sink_ready -> LDA_s1_agent:rp_ready
	wire         lda_s1_agent_rp_startofpacket;                                               // LDA_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire         lda_s1_agent_rp_endofpacket;                                                 // LDA_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire         lda_s1_agent_rdata_fifo_src_valid;                                           // LDA_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire  [33:0] lda_s1_agent_rdata_fifo_src_data;                                            // LDA_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire         lda_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_005:in_0_ready -> LDA_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_005_out_0_valid;                                           // avalon_st_adapter_005:out_0_valid -> LDA_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_005_out_0_data;                                            // avalon_st_adapter_005:out_0_data -> LDA_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_005_out_0_ready;                                           // LDA_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire   [0:0] avalon_st_adapter_005_out_0_error;                                           // avalon_st_adapter_005:out_0_error -> LDA_s1_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.clk                    (clk_0_clk_clk),                             //                      clk.clk
		.reset                  (nios2_reset_n_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (lda_s1_agent_m0_address),                   // avalon_universal_slave_0.address
		.uav_burstcount         (lda_s1_agent_m0_burstcount),                //                         .burstcount
		.uav_read               (lda_s1_agent_m0_read),                      //                         .read
		.uav_write              (lda_s1_agent_m0_write),                     //                         .write
		.uav_waitrequest        (lda_s1_agent_m0_waitrequest),               //                         .waitrequest
		.uav_readdatavalid      (lda_s1_agent_m0_readdatavalid),             //                         .readdatavalid
		.uav_byteenable         (lda_s1_agent_m0_byteenable),                //                         .byteenable
		.uav_readdata           (lda_s1_agent_m0_readdata),                  //                         .readdata
		.uav_writedata          (lda_s1_agent_m0_writedata),                 //                         .writedata
		.uav_lock               (lda_s1_agent_m0_lock),                      //                         .lock
		.uav_debugaccess        (lda_s1_agent_m0_debugaccess),               //                         .debugaccess
		.av_address             (LDA_s1_address),                            //      avalon_anti_slave_0.address
		.av_write               (LDA_s1_write),                              //                         .write
		.av_read                (LDA_s1_read),                               //                         .read
		.av_readdata            (LDA_s1_readdata),                           //                         .readdata
		.av_writedata           (LDA_s1_writedata),                          //                         .writedata
		.av_waitrequest         (LDA_s1_waitrequest),                        //                         .waitrequest
		.av_begintransfer       (),                                          //              (terminated)
		.av_beginbursttransfer  (),                                          //              (terminated)
		.av_burstcount          (),                                          //              (terminated)
		.av_byteenable          (),                                          //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                             //             clk.clk
		.reset                   (nios2_reset_n_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (lda_s1_agent_m0_address),                   //              m0.address
		.m0_burstcount           (lda_s1_agent_m0_burstcount),                //                .burstcount
		.m0_byteenable           (lda_s1_agent_m0_byteenable),                //                .byteenable
		.m0_debugaccess          (lda_s1_agent_m0_debugaccess),               //                .debugaccess
		.m0_lock                 (lda_s1_agent_m0_lock),                      //                .lock
		.m0_readdata             (lda_s1_agent_m0_readdata),                  //                .readdata
		.m0_readdatavalid        (lda_s1_agent_m0_readdatavalid),             //                .readdatavalid
		.m0_read                 (lda_s1_agent_m0_read),                      //                .read
		.m0_waitrequest          (lda_s1_agent_m0_waitrequest),               //                .waitrequest
		.m0_writedata            (lda_s1_agent_m0_writedata),                 //                .writedata
		.m0_write                (lda_s1_agent_m0_write),                     //                .write
		.rp_endofpacket          (lda_s1_agent_rp_endofpacket),               //              rp.endofpacket
		.rp_ready                (lda_s1_agent_rp_ready),                     //                .ready
		.rp_valid                (lda_s1_agent_rp_valid),                     //                .valid
		.rp_data                 (lda_s1_agent_rp_data),                      //                .data
		.rp_startofpacket        (lda_s1_agent_rp_startofpacket),             //                .startofpacket
		...
		.rf_sink_ready           (lda_s1_agent_rsp_fifo_out_ready),           //         rf_sink.ready
		.rf_sink_valid           (lda_s1_agent_rsp_fifo_out_valid),           //                .valid
		.rf_sink_startofpacket   (lda_s1_agent_rsp_fifo_out_startofpacket),   //                .startofpacket
		.rf_sink_endofpacket     (lda_s1_agent_rsp_fifo_out_endofpacket),     //                .endofpacket
		.rf_sink_data            (lda_s1_agent_rsp_fifo_out_data),            //                .data
		.rf_source_ready         (lda_s1_agent_rf_source_ready),              //       rf_source.ready
		.rf_source_valid         (lda_s1_agent_rf_source_valid),              //                .valid
		.rf_source_startofpacket (lda_s1_agent_rf_source_startofpacket),      //                .startofpacket
		.rf_source_endofpacket   (lda_s1_agent_rf_source_endofpacket),        //                .endofpacket
		.rf_source_data          (lda_s1_agent_rf_source_data),               //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_005_out_0_ready),         // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_005_out_0_valid),         //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_005_out_0_data),          //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_005_out_0_error),         //                .error
		.rdata_fifo_src_ready    (lda_s1_agent_rdata_fifo_src_ready),         //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (lda_s1_agent_rdata_fifo_src_valid),         //                .valid
		.rdata_fifo_src_data     (lda_s1_agent_rdata_fifo_src_data),          //                .data
		.m0_response             (2'b00),                                     //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                       //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) lda_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                             //       clk.clk
		.reset             (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (lda_s1_agent_rf_source_data),               //        in.data
		.in_valid          (lda_s1_agent_rf_source_valid),              //          .valid
		.in_ready          (lda_s1_agent_rf_source_ready),              //          .ready
		.in_startofpacket  (lda_s1_agent_rf_source_startofpacket),      //          .startofpacket
		.in_endofpacket    (lda_s1_agent_rf_source_endofpacket),        //          .endofpacket
		.out_data          (lda_s1_agent_rsp_fifo_out_data),            //       out.data
		.out_valid         (lda_s1_agent_rsp_fifo_out_valid),           //          .valid
		.out_ready         (lda_s1_agent_rsp_fifo_out_ready),           //          .ready
		.out_startofpacket (lda_s1_agent_rsp_fifo_out_startofpacket),   //          .startofpacket
		.out_endofpacket   (lda_s1_agent_rsp_fifo_out_endofpacket),     //          .endofpacket
		.csr_address       (2'b00),                                     // (terminated)
		.csr_read          (1'b0),                                      // (terminated)
		.csr_write         (1'b0),                                      // (terminated)
		.csr_readdata      (),                                          // (terminated)
	...
	nios_system_mm_interconnect_0_router_002 router_007 (
		.sink_ready         (lda_s1_agent_rp_ready),                     //      sink.ready
		.sink_valid         (lda_s1_agent_rp_valid),                     //          .valid
		.sink_data          (lda_s1_agent_rp_data),                      //          .data
		.sink_startofpacket (lda_s1_agent_rp_startofpacket),             //          .startofpacket
		.sink_endofpacket   (lda_s1_agent_rp_endofpacket),               //          .endofpacket
		.clk                (clk_0_clk_clk),                             //       clk.clk
		.reset              (nios2_reset_n_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	nios_system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                             // in_clk_0.clk
		.in_rst_0_reset (nios2_reset_n_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (lda_s1_agent_rdata_fifo_src_data),          //     in_0.data
		.in_0_valid     (lda_s1_agent_rdata_fifo_src_valid),         //         .valid
		.in_0_ready     (lda_s1_agent_rdata_fifo_src_ready),         //         .ready
