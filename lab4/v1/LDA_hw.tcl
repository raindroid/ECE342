...
# Sun Feb 09 22:48:02 EST 2020
# DO NOT MODIFY


# 
# LDA "LDA" v0.9
# Vicky & Rain 2020.02.09.22:48:02
# 
# 
...
add_fileset_file reg_n.sv SYSTEM_VERILOG PATH lda/reg_n.sv
add_fileset_file vga_adapter.sdc SDC PATH vga/vga_adapter.sdc
add_fileset_file vga_adapter.sv SYSTEM_VERILOG PATH vga/vga_adapter.sv
add_fileset_file vga_input.sv SYSTEM_VERILOG PATH vga/vga_input.sv
add_fileset_file vga_memory.sv SYSTEM_VERILOG PATH vga/vga_memory.sv
add_fileset_file vga_output.sv SYSTEM_VERILOG PATH vga/vga_output.sv
add_fileset_file vgapll.v VERILOG PATH vga/vgapll.v
